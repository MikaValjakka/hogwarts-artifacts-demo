package xyz.mikavee.hogwartsartifactsonline.hogwartsuser;
...
public class UserService implements UserDetailsService {
    ...
    public HogwartsUser save(HogwartsUser newHogwartsUser) {
        // Here using password encoder to encode plaintext password -> bcrypt
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        return this.userRepository.findByUsername(username)
                .map(hogwartsUser -> new MyUserPrincipal(hogwartsUser))// wrap returned user instance in MyUserPrincipal instance
