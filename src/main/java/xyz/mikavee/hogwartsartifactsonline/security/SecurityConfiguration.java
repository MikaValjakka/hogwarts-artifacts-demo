...
public class SecurityConfiguration {
    ...
    /*
    * Spring Security automatically recognizes the SecurityFilterChain bean
    * by looking for a bean of type SecurityFilterChain in the Spring application context.
    * */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .oauth2ResourceServer(oauth2ResourceServer -> oauth2ResourceServer.jwt(jwt -> jwt.jwtAuthenticationConverter(jwtAuthenticationConverter()))
                        //.and().authenticationEntryPoint(this.customBearerTokenAuthenticationEntryPoint)) <- Old code just for reference, please do not remove
