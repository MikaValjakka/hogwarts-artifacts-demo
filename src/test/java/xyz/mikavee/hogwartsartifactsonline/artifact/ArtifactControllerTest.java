...
@SpringBootTest
@AutoConfigureMockMvc(addFilters = false) // turn off Spring Security in unit test
class ArtifactControllerTest {
    ...
    void testSaveArtifactSuccess() throws Exception {
        ...
        //Given
        ArtifactDto artifactDto = new ArtifactDto(null, "Artifact", "Long description.","ImageUrl", null);

        // The artifactDto object is parsed as JSON using the objectMapper.
        String json = this.objectMapper.writeValueAsString(artifactDto);

        Artifact savedArtifact = new Artifact();
        savedArtifact.setId("12345");
        savedArtifact.setName("Artifact");
        savedArtifact.setDescription("Long description.");
    ...
    void testUpdateArtifactSuccess() throws Exception {
        //Given
        ArtifactDto artifactDto = new ArtifactDto("12345", "Artifact", "Long description.","ImageUrl", null);
        ...
        updatedArtifact.setName(" NewArtifact");
        updatedArtifact.setDescription("Updated description.");
        updatedArtifact.setImageUrl("new ImageUrl");

        given(this.artifactService.update(eq("12345"),Mockito.any(Artifact.class))).willReturn(updatedArtifact);

        // When and Then
        this.mockMvc.perform(MockMvcRequestBuilders.put(this.baseUrl+"/artifacts/12345")
    ...
    @Test
    void testUpdateArtifactErrorWithNonExistedId() throws Exception {
        //Given
        ArtifactDto artifactDto = new ArtifactDto("12345", "Artifact", "Long description.","ImageUrl", null);
        ...
        given(this.artifactService.update(eq("12345"),Mockito.any(Artifact.class)))
                .willThrow(new ArtifactNotFoundException("12345"));
    ...
    void testDeleteArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(MockMvcRequestBuilders.delete(this.baseUrl+"/artifacts/123456789")
    ...
    void testDeleteArtifactErrorWithNonExistentId() throws Exception {
        // Give
        // when delete from service class is called, throw this exception
